...
def _tensor_quant_in_list(act_quant, module_list, same_sign):
    ...
    for m in module_list:
      ...
      and m_tq.scaling_impl is tq.scaling_impl
      and (m_tq.int_scaling_impl if hasattr(m_tq, 'int_scaling_impl') else m_tq.float_scaling_impl)
          is (tq.int_scaling_impl if hasattr(tq, 'int_scaling_impl') else tq.float_scaling_impl)):
            return True
    return False
