...
RESULTS_DIR       = '/root/arcade/final_scripts/final_results/quantization/shufflenetv2/cifar10'
MODEL_DIR         = '/root/arcade/final_scripts/final_models/shufflenet_models'
MODEL_PATH        = os.path.join(MODEL_DIR, "shufflenet_v2_x1_0_cifar10_best.pth")
...
for repl_name, repl_fn in replacement_variants:
    ...
    base_model.fc = nn.Linear(in_feats, 10)
